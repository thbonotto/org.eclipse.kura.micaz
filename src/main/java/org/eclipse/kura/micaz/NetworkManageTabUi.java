...
public class NetworkManageTabUi extends Composite {
	
	@UiField
	TextBox serialInterface;
	...
	@UiField
	Button nodeUnassociate;
	
	@UiField
	Button nodeRefresh;

	@UiField
    CellTable<GwtGroupedNVPair> nodesGrid = new CellTable<GwtGroupedNVPair>();
	private final ListDataProvider<GwtGroupedNVPair> nodesDataProvider = new ListDataProvider<GwtGroupedNVPair>();
    ...
    private static final Messages MSGS = GWT.create(Messages.class);
	 ...
	 private void updateNodesTable(CellTable<GwtGroupedNVPair> grid,
